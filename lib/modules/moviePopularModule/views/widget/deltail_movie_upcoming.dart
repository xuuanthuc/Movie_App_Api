...
class DetailMovieUpcoming extends StatelessWidget {
  MovieUpcomingController movieTopRateController = Get.find();
  ...
  Widget build(BuildContext context) {
    ...
    var loadedMovie = movieTopRateController.findById(movieId);
    return Scaffold(
      body: Container(
        color: Colors.white,
